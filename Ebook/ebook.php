...
<body>
    ...
    <div class="flex-content">
        <div class="left-content">
            ...
            <!-- <a href="?page=1" class="genre 
                <?php if(!isset($_POST["genre"])) : echo 'active'; endif;?>">All</a> -->
            <!-- <form action="" method="post" class="back-button-form">
                <button type="submit" name="back-button" class="back-button">
                    <img class="back-button-arrow" src="./Asset/back-button.svg">
                </button>
            </form> -->
            <div class="back-button">
                <a href="../Catalogs/catalogs.php"><img src="./Asset/back-button.svg" alt="Back"></a>
            </div>
        </div>
