...
<header>
    ...
    <div class="flex-content">
        <div class="left-content">
            ...
            <!-- <a href="../Catalogs/catalogs.php" class="genre 
                <?php if(!isset($_POST["genre"])) : echo 'active'; endif;?>">All</a> -->
        </div>
        <div class="right-content">
            ...
            <div class="book-container">
                <div class="book-header-container">
                    ...
                    <!-- <form action="" method="post" class="next-button-form">
                        <button type="submit" name="next-button" class="next-button">
                            <img class="next-button-arrow" src="./Asset/next-button.svg">
                        </button>
                    </form> -->
                    <div class="next-button">
                        <a href="../Physical-Book/physicalbook.php?page=1"><img src="./Asset/next-button.svg" alt="Next Page"></a>
                    </div>
                </div>
            ...
            <div class="book-container">
                <div class="book-header-container">
                    ...
                    <div class="next-button">
                        <a href="../Ebook/ebook.php"><img src="./Asset/next-button.svg" alt="Next Page"></a>
                    </div>
                </div>
                <form action="" method="post" class="list-container">
