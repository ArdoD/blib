<?php 
    ...
    if(isset($_POST["borrow"])){
        ...
        if($ebook["StokE-Book"] > 0){
            ...
            header("Location: ../Catalogs/catalogs.php");
            exit;
        }
...
<body>
    <div class="flex-content">
        <!-- <div class="back-button">
            <a href=""><img class="back-button-img" src="./Asset/back-button.svg"> </a>
        </div> -->
        <div class="left-content">
            <div class="back-button">
                <a href="../Catalogs/catalogs.php"><img class="back-button-img" src="./Asset/back-button.svg"> </a>
            </div>
